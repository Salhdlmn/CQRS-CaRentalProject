...
{
    public class RapidApiGasPrice
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public RapidApiGasPrice(IHttpClientFactory httpClientFactory)
        {
            _httpClientFactory = httpClientFactory;
        }

        public async Task<RapidApiGasPriceViewModel> GetGasPricesAsync()
        {
            ...
            var model = new RapidApiGasPriceViewModel
            {
